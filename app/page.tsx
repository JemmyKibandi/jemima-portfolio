      ...
      <section ref={heroRef} className="min-h-screen bg-white flex items-center justify-center px-6">
        <div className="max-w-4xl mx-auto text-start space-y-8">
          <div className="space-y-4">
            <h1 className="hero-title text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
              Vinicius Ferreira —
            </h1>
            <p className="hero-description text-4xl sm:text-5xl lg:text-6xl xl:text-7xl">
